...
class ScanScreenState extends State<ScanScreen> {
  ...
  // NetworkChecking networkChecking = NetworkChecking();
  ...
  void dispose() {
    ...
    //networkChecking.netDismiss();
  }

  initPrefs() async {
    // await getToken();
    profile = await UtilService.getProfile();
    // if (networkChecking.connectionStatus == 'Unknownxx') {
    //   print('ไม่มีการเชื่อมต่อ Internet');
    // } else {
    getCurrentLocation();
    getTypeScan();
    getHistoryScan();
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          ...
          content: Text("ไม่สามารถขอข้อมูลตำแหน่งปัจจุบันได้"),
        ),
      );
