...
class AbsentApproverPage extends StatefulWidget {
  const AbsentApproverPage({Key? key}) : super(key: key);

  @override
  AbsentApproverPageState createState() => AbsentApproverPageState();
}

class AbsentApproverPageState extends State<AbsentApproverPage> {
