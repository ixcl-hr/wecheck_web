...
class AbsentApprovePageState extends State<AbsentApprovePage> {
  ...
  Row buildApprover(BuildContext context) {
    return Row(
      ...
      children: [
        ...
        SizedBox(
          width: MediaQuery.of(context).size.width * 0.60,
          child: absentApproverList.isEmpty
              ? const Text('')
              : FormBuilderDropdown(
                  name: 'approverid',
                  decoration: InputDecoration(
  ...
  void onConfirmApproveSelected() {
    Alert(
      ...
      desc: UtilService.getTextFromLang(
          "question_approve_selected_item", "ยืนยันอนุมัติลางานรายการที่เลือก"),
      buttons: [
        DialogButton(
          onPressed: () {
            onApproveSelected();
  ...
  void onConfirmCancelSelected() {
    Alert(
      ...
      title: "We check",
      desc: UtilService.getTextFromLang(
          "question_cancel_selected_item", "ต้องการยกเลิกรายการลาที่เลือก"),
      buttons: [
        DialogButton(
          onPressed: () {
            unApproveSelected();
