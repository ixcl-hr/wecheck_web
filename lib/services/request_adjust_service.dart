...
class RequestAdjustService {
  requestAdjust(Profile profile, payload, context) async {
    var header = {
      'Content-Type': 'application/json',
      'Authorization': 'Bearer ${profile.token}'
    };
    String url = '${ApiMaster}RequestAdjust';
    var response =
    ...
    if (response.statusCode == 200) {
      if (feedback['flag'] == true) {
        showAlert(context, 'สร้างคำขอปรับเวลาสำเร็จ', AlertType.success, () {
